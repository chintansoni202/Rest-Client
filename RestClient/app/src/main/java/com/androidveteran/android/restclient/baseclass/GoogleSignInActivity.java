...
import com.androidveteran.android.restclient.activity.HomeActivity;
...
public abstract class GoogleSignInActivity extends BaseAppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
...
//                        updateUI(false);
    ...
    public abstract void signInResult(GoogleSignInResult googleSignInResult);
}
